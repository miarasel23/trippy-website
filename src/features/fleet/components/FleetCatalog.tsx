...
import { customerTripService, getImageUrl } from '@/features/trips/services/customerTripService';
import { ServiceCategory, CarInfo } from '@/features/trips/types/customerApi';
