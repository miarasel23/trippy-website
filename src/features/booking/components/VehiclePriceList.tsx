...
import { CarInfo, ServiceCategory } from '@/features/trips/types/customerApi';
import { getImageUrl, customerTripService } from '@/features/trips/services/customerTripService';
