              ...
              <div className="relative" ref={userMenuRef}>
                ...
                >
                  ...
                  <div className="text-left">
                    <span className="text-xs font-bold text-slate-900 block truncate max-w-[90px] leading-tight">
                      {user?.full_name?.split(' ')[0] || 'User'}
                    </span>
                    <span className="text-[10px] text-emerald-700 font-semibold flex items-center gap-1 leading-none">
                      <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
                      {user?.role?.name || t.auth.customerRole}
                    </span>
                  </div>
