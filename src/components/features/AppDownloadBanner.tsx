  ...
  return (
    <section className="py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-cyan-500/30 bg-gradient-to-br from-emerald-900/30 via-brand-surface/90 to-cyan-900/30 p-8 sm:p-12 lg:p-16 backdrop-blur-2xl shadow-2xl">
          
          {/* Subtle decorative glow */}
          <div className="absolute top-0 right-0 w-96 h-96 bg-brand-primary/10 rounded-full blur-3xl pointer-events-none" />
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-brand-secondary/10 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
            ...
            <div className="lg:col-span-8">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight font-heading mb-4 leading-tight">
                Download The Tripyy Customer App Today
              </h2>
              <p className="text-slate-300 text-base sm:text-lg leading-relaxed mb-8 max-w-2xl">
                Enjoy instant messaging with drivers, foreground service live tracking, trip history, and flexible fare negotiation on your phone.
              </p>

              <div className="flex flex-wrap items-center gap-4">
                <Link
                  href="/app"
                  className="btn btn-primary py-3 px-6 rounded-xl font-bold text-sm flex items-center gap-2.5 shadow-glow"
                >
                ...
                <Link
                  href="/app"
                  className="btn btn-secondary py-3 px-6 rounded-xl font-semibold text-sm flex items-center gap-2.5 border-white/20 hover:border-white/40"
                >
                  <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
            ...
            <div className="lg:col-span-4 flex lg:justify-end">
              <QrCodeBox
                category="Scan on Your Phone"
                title="Instant QR Scan"
                subtitle="Direct download APK & App Store link"
